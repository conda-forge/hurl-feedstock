...
:: Patch libxml 0.3.9 default_binding.rs see <https://github.com/KWARC/rust-libxml/issues/179>
xcopy /E /I /Y "%RECIPE_DIR%\patch\rust-libxml-0.3.9" "%SRC_DIR%\patch\rust-libxml-0.3.9"
